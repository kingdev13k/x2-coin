...
import barCode from "../assets/USDC.png"
                ...
                <div className="formGroup">
                    ...
                    <div className="formInput formInputWithButton">
                        ...
                        <div className="input"><span className="errorText"> The minimum value allowed is
                            2000</span><span>USDC</span></div><button className="disabled"> Copy amount </button>
                    </div>
                    ...
                    <div className="block">
                        ...
                        <div className="formGroup">
                            <div><label className="input"><input onChange={handleAmount} placeholder="Enter Amount" type="number" /><span className="currency">USDC</span></label>
                                <div className="group"><small className="small"> Min: <span>2000 USDC</span></small><small
                                    className="small"> Max: <span>50,000 USDC</span></small></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="calculatorInput formContainer">
                    ...
                    <div className="block">
                        ...
                        <div><label className="input"><input defaultValue={amount} placeholder="Waiting for input..." type="number" /><span
                            ...
                            <div className="group"><small className="small"> Min: <span>4000 USDC</span></small><small
                                className="small"> Max: <span>100,000 USDC</span></small></div>
                        </div>
                    </div>
